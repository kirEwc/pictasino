...
const SportsCard: React.FC<CardCustomProps> = ({
  ...
  return (
    <div className="relative p-6 rounded-2xl shadow-[8px_8px_0px_#151e2b,-8px_-8px_0px_#1d283b] w-full max-w-md bg-slate-800 hover:bg-gray-800 border-gray-950 overflow-hidden mb-7">
      <div
        id="Mancha De color en la card"
        className={`absolute ${manchaPosition} ${manchaSize} ${manchaColor} blur-2xl opacity-80 rounded-full`}
      ></div>
      ...
      <div className="relative flex ">
        ...
        <div className="ml-2 flex items-end">
          <Link href={Ruta}>
            <button className="w-9 h-9 flex items-center justify-center rounded-lg bg-[#a11212] shadow-[5px_5px_20px_#890f0f,-5px_-5px_20px_#b91515] hover:bg-[#c61313] hover:shadow-[5px_5px_20px_#c61313,-5px_-5px_20px_#ff1919] transition-all duration-300 ease-in-out">
